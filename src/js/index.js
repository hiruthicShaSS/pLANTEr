...
document.getElementById("find-friends").addEventListener("click", findFriends);
// END: Event Binders ====================================================================================

// Find friends
function findFriends() {
    var countries = []; // List of users will be added here
    ...
    autocomplete(document.getElementById("friends"), countries);

    $("#modal-find_friends").modal("open");
}
